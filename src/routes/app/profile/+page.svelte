    ...
    <div class="body">
        ...
        <div class="body-row">
            <div class="input-box">
                ...
                <input type="street_address" name="street_address" id="street_address" placeholder="enter street address" />
            </div>
        </div>
        <div class="body-row">
            <div class="input-box">
        ...
        <div class="body-row">
            ...
            <div class="input-box">
                ...
                <input type="postcode" name="postcode" id="postcode" placeholder="enter postcode" />
            </div>
        </div>
    </div>
</div>
