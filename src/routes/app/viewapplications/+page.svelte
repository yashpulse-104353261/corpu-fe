<div class="profile">
    ...
    <div class="body">
        ...
        <!-- 1 -->
        <div class="body-row">
            <div class="unit unsuccessful-box">
                <div class="unit-info">
                    <div class="unit-info-top">
                        <div class="unit-info-kv">
                            <span>Unit Code</span>
                ...
                <div class="unit-controls">
                    ...
                    <div class="applicantion-status">
                        <div class="unit-info-kv">
                            <span>Status</span>
                            <span class="unsuccessful">Unsuccessful</span>
                        </div>
                    </div>
                </div>
            </div>
